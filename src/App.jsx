...
function App() {
  ...
  return (
    ...
    <main className='py-4 overflow-x-hidden'>
      <p>
      ...
      <fieldset className='border p-2 rounded-lg text-center w-full sm:w-auto'>
        ...
        <div className='bg-gray-200 p-1 rounded text-black font-mono sm:text-2xl max-w-full' id="resultat">
